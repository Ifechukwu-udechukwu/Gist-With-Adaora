          ...
          <div className="w-full max-w-sm p-6 max-md:m-6 border border-black/30 shadow-xl shadow-black/15 rounded-lg">
            <div className="flex flex-col items-center justify-center">
                 <div className="w-full py-6 text-center">
                    <h1 className="text-3xl font-bold"><span className="text-pink-500">Admin</span> Login</h1>
                    <p className="font-light">Enter your credentials to access the admin panel</p>
                 </div>

                 <form onSubmit={handleSubmit} className="mt-6 w-full sm:max-w-md text-black-600">
                    ...
                    <button type="submit" className="w-full py-3 font-medium bg-pink-500 text-black rounded cursor-pointer hover:bg-pink-700 transition-all">Login</button>
                 </form>
            </div>
          </div>
        </div>
